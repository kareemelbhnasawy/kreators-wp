...
function append() {
    ...
    for (let s = 0; s < arguments.length; s += 1) {
        ...
        for (let s = 0; s < this.length; s += 1)
            ...
            } else if (e instanceof Dom7) for (let t = 0; t < e.length; t += 1) this[s].appendChild(e[t]);
            ...
            c[i] && (c[i].swiperSlideSize = C),
                ...
                a.centeredSlides
                    ? ((x = x + C / 2 + y / 2 + b),
                      ...
                      h.push(x))
                    : (a.roundLengths && (x = Math.floor(x)), ($ - Math.min(e.params.slidesPerGroupSkip, $)) % e.params.slidesPerGroup == 0 && u.push(x), h.push(x), (x = x + C + b)),
                (e.virtualSize += C + b),
                (y = C),
                ($ += 1);
        }
...
function updateClickedSlide(e) {
    ...
    (t.clickedSlide = a),
        t.virtual && t.params.virtual.enabled ? (t.clickedIndex = parseInt($(a).attr("data-swiper-slide-index"), 10)) : (t.clickedIndex = i),
...
function setTranslate(e, t) {
    ...
    s.isHorizontal() ? (o = a ? -e : e) : (d = e),
        ...
        i.cssMode ? (n[s.isHorizontal() ? "scrollLeft" : "scrollTop"] = s.isHorizontal() ? -o : -d) : i.virtualTranslate || r.transform(`translate3d(${o}px, ${d}px, 0px)`),
...
function onTouchMove(e) {
    ...
    if (!s.allowTouchMove) return $(o.target).is(a.focusableElements) || (s.allowClick = !1), void (a.isTouched && (Object.assign(r, { startX: c, startY: p, currentX: c, currentY: p }), (a.touchStartTime = now())));
    ...
    if (void 0 === a.isScrolling) {
        ...
        (s.isHorizontal() && r.currentY === r.startY) || (s.isVertical() && r.currentX === r.startX)
            ? (a.isScrolling = !1)
            : u * u + h * h >= 25 && ((e = (180 * Math.atan2(Math.abs(h), Math.abs(u))) / Math.PI), (a.isScrolling = s.isHorizontal() ? e > i.touchAngle : 90 - e > i.touchAngle));
    }
    ...
    if (
        ...
        m > 0 && a.currentTranslate > s.minTranslate()
            ? ((f = !1), i.resistance && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + m) ** g))
            : m < 0 && a.currentTranslate < s.maxTranslate() && ((f = !1), i.resistance && (a.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - a.startTranslate - m) ** g)),
...
function onTouchEnd(e) {
    ...
    if (c > a.longSwipesMs) {
        ...
        "next" === t.swipeDirection && (g >= a.longSwipesRatio ? t.slideTo(a.rewind && t.isEnd ? m : u + v) : t.slideTo(u)),
            "prev" === t.swipeDirection && (g > 1 - a.longSwipesRatio ? t.slideTo(u + v) : null !== f && g < 0 && Math.abs(g) > a.longSwipesRatio ? t.slideTo(f) : t.slideTo(u));
    } else {
...
const events = (e, t) => {
    ...
    (a.preventClicks || a.preventClicksPropagation) && r[c]("click", e.onClick, !0),
        ...
        a.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", onResize, !0) : e[p]("observerUpdate", onResize, !0);
};
function attachEvents() {
    ...
    (e.onTouchStart = onTouchStart.bind(e)),
        ...
        a.touch && !dummyEventAttached && (t.addEventListener("touchstart", dummyEventListener), (dummyEventAttached = !0)),
        events(e, "on");
}
...
function Pagination(e) {
    ...
    function c() {
        ...
        if (
            ...
            if (
                (s.dynamicBullets &&
                    ...
                    s.dynamicMainBullets > 1 && void 0 !== t.previousIndex && ((l += c - (t.previousIndex - t.loopedSlides || 0)), l > s.dynamicMainBullets - 1 ? (l = s.dynamicMainBullets - 1) : l < 0 && (l = 0)),
                    (i = Math.max(c - l, 0)),
        ...
        "custom" === s.type && s.renderCustom ? (r.html(s.renderCustom(t, c + 1, p)), i("paginationRender", r[0])) : i("paginationUpdate", r[0]),
    ...
    function u() {
        ...
        let s = $(e.el);
        0 !== s.length &&
            (t.params.uniqueNavElements && "string" == typeof e.el && s.length > 1 && ((s = t.$el.find(e.el)), s.length > 1 && (s = s.filter((e) => $(e).parents(".swiper")[0] === t.el))),
...
function Scrollbar(e) {
    ...
    function h() {
        ...
        s ? ((c = -c), c > 0 ? ((d = l - c), (c = 0)) : -c + l > o && (d = o + c)) : c < 0 ? ((d = l + c), (c = 0)) : c + l > o && (d = o - c),
            t.isHorizontal() ? (i.transform(`translate3d(${c}px, 0, 0)`), (i[0].style.width = `${d}px`)) : (i.transform(`translate3d(0px, ${c}px, 0)`), (i[0].style.height = `${d}px`)),
            n.hide &&
                (clearTimeout(p),
                (r[0].style.opacity = 1),
                (p = setTimeout(() => {
    ...
    function v(e) {
        const s = t.params.scrollbar,
            ...
            { $el: l, $dragEl: o } = a;
        (c = !0),
            (n = e.target === o[0] || e.target === o ? f(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null),
            e.preventDefault(),
            e.stopPropagation(),
            r.transition(100),
            o.transition(100),
    ...
    function x(e) {
        ...
        if (!o) return;
        const d = o[0],
            c = !(!l.passiveListener || !n.passiveListeners) && { passive: !1, capture: !1 },
    ...
    function y() {
        ...
        0 === r.length && ((r = $(`<div class="${t.params.scrollbar.dragClass}"></div>`)), i.append(r)),
...
function Zoom(e) {
    ...
    function v(e) {
        ...
        p.$imageEl && 0 !== p.$imageEl.length
            ? (s.gestures ? (i.scale = e.scale * d) : (i.scale = (p.scaleMove / p.scaleStart) * d),
    ...
    function w(e) {
        ...
        p.$imageEl &&
            0 !== p.$imageEl.length &&
            ((r.scale = Math.max(Math.min(r.scale, p.maxRatio), i.minRatio)), p.$imageEl.transition(t.params.speed).transform(`translate3d(0,0,0) scale(${r.scale})`), (d = r.scale), (c = !1), 1 === r.scale && (p.$slideEl = void 0));
    }
    function b(e) {
        const s = t.zoom;
        ...
        if (!(a < p.slideWidth && i < p.slideHeight)) {
            if (
                ...
                (u.maxY = -u.minY),
                (u.touchesCurrent.x = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX),
                (u.touchesCurrent.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY),
                !u.isMoved && !c)
            ) {
    ...
    function y(e) {
        ...
        if (
            (p.$slideEl ||
                (e && e.target && (p.$slideEl = $(e.target).closest(`.${t.params.slideClass}`)),
        ...
        t.params.cssMode && ((t.wrapperEl.style.overflow = "hidden"), (t.wrapperEl.style.touchAction = "none")),
            ...
            void 0 === u.touchesStart.x && e ? ((i = "touchend" === e.type ? e.changedTouches[0].pageX : e.pageX), (n = "touchend" === e.type ? e.changedTouches[0].pageY : e.pageY)) : ((i = u.touchesStart.x), (n = u.touchesStart.y)),
    ...
    function E() {
        const e = t.zoom,
            s = t.params.zoom;
        p.$slideEl ||
            (t.params.virtual && t.params.virtual.enabled && t.virtual ? (p.$slideEl = t.$wrapperEl.children(`.${t.params.slideActiveClass}`)) : (p.$slideEl = t.slides.eq(t.activeIndex)),
    ...
    function z() {
        ...
        s.gestures
            ...
            : "touchstart" === t.touchEvents.start &&
              (t.$wrapperEl.on(t.touchEvents.start, r, g, a), t.$wrapperEl.on(t.touchEvents.move, r, v, i), t.$wrapperEl.on(t.touchEvents.end, r, w, a), t.touchEvents.cancel && t.$wrapperEl.on(t.touchEvents.cancel, r, w, a)),
            t.$wrapperEl.on(t.touchEvents.move, `.${t.params.zoom.containerClass}`, b, i);
    }
    function O() {
        const e = t.zoom;
        if (!e.enabled) return;
        ...
        s.gestures
            ...
            : "touchstart" === t.touchEvents.start &&
              (t.$wrapperEl.off(t.touchEvents.start, r, g, a), t.$wrapperEl.off(t.touchEvents.move, r, v, i), t.$wrapperEl.off(t.touchEvents.end, r, w, a), t.touchEvents.cancel && t.$wrapperEl.off(t.touchEvents.cancel, r, w, a)),
            t.$wrapperEl.off(t.touchEvents.move, `.${t.params.zoom.containerClass}`, b, i);
    }
                ...
                (function (e) {
                    ...
                    p.$imageEl &&
                        ...
                        (u.isTouched ||
                            ...
                            (u.isTouched = !0),
                            (u.touchesStart.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX),
                            (u.touchesStart.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY)));
                })(s);
        }),
        a("touchEnd", (e, s) => {
            t.zoom.enabled &&
...
function Lazy(e) {
    ...
    function d() {
        ...
        const h = !("touchstart" !== t.touchEvents.start || !t.support.passiveListener || !t.params.passiveListeners) && { passive: !0, capture: !1 };
...
function A11y(e) {
    ...
    function h(e) {
        ...
        t.navigation && t.navigation.$nextEl && a.is(t.navigation.$nextEl) && ((t.isEnd && !t.params.loop) || t.slideNext(), t.isEnd ? r(s.lastSlideMessage) : r(s.nextSlideMessage)),
            ...
            t.pagination && a.is(classesToSelector(t.params.pagination.bulletClass)) && a[0].click();
    }
    function m() {
    ...
    const g = (e, t, s) => {
        ...
        b = () => {
            ...
            (o = r),
                ...
                f() && t.pagination.$el.on("keydown", classesToSelector(t.params.pagination.bulletClass), h),
                t.$el.on("focus", v, !0);
        };
    a("beforeInit", () => {
                ...
                (function () {
                    ...
                    m() &&
                        t.pagination.bullets.each((s) => {
                            const a = $(s);
                            t.params.pagination.clickable && (n(a), t.params.pagination.renderBullet || (o(a, "button"), c(a, e.paginationBulletMessage.replace(/\{\{index\}\}/, a.index() + 1)))),
            ...
            t.params.a11y.enabled &&
                (function () {
                    ...
                    i && i.length > 0 && i.remove(),
                        ...
                        e && e.off("keydown", h),
                        s && s.off("keydown", h),
                        f() && t.pagination.$el.off("keydown", classesToSelector(t.params.pagination.bulletClass), h),
                        t.$el.off("focus", v, !0);
                })();
        });
}
                ...
                onTouchEnd: function (e) {
                    ...
                    if (s < -t.minTranslate()) t.slideTo(t.activeIndex);
                        ...
                        if (r.freeMode.momentum) {
                            ...
                            let m;
                            if (c < t.maxTranslate())
                                r.freeMode.momentumBounce ? (c + t.maxTranslate() < -h && (c = t.maxTranslate() - h), (p = t.maxTranslate()), (u = !0), (d.allowMomentumBounce = !0)) : (c = t.maxTranslate()),
                                    r.loop && r.centeredSlides && (m = !0);
                            else if (c > t.minTranslate())
                                r.freeMode.momentumBounce ? (c - t.minTranslate() > h && (c = t.minTranslate() + h), (p = t.minTranslate()), (u = !0), (d.allowMomentumBounce = !0)) : (c = t.minTranslate()),
                                    r.loop && r.centeredSlides && (m = !0);
...
function EffectFade(e) {
    ...
    effectInit({
        ...
        setTransition: (e) => {
            ...
            (s ? t.slides.find(s) : t.slides).transition(e), effectVirtualTransitionEnd({ swiper: t, duration: e, transformEl: s, allSlides: !0 });
        },
...
function EffectCube(e) {
    ...
    const i = (e, t, s) => {
        ...
        0 === a.length && ((a = $(`<div class="swiper-slide-shadow-${s ? "left" : "top"}"></div>`)), e.append(a)),
    ...
    effectInit({
        ...
        setTranslate: () => {
            ...
            c.shadow &&
                (p
                    ? ((h = s.find(".swiper-cube-shadow")), 0 === h.length && ((h = $('<div class="swiper-cube-shadow"></div>')), s.append(h)), h.css({ height: `${r}px` }))
            ...
            for (let e = 0; e < a.length; e += 1) {
                ...
                let h = 0,
                    f = 0,
                    g = 0;
                s % 4 == 0 ? ((h = 4 * -n * o), (g = 0)) : (s - 1) % 4 == 0 ? ((h = 0), (g = 4 * -n * o)) : (s - 2) % 4 == 0 ? ((h = o + 4 * n * o), (g = o)) : (s - 3) % 4 == 0 && ((h = -o), (g = 3 * o + 4 * o * n)),
                    l && (h = -h),
                    p || ((f = h), (h = 0));
...
function EffectFlip(e) {
    ...
    const i = (e, s, a) => {
        ...
        0 === i.length && (i = createShadow(a, e, t.isHorizontal() ? "left" : "top")),
            0 === r.length && (r = createShadow(a, e, t.isHorizontal() ? "right" : "bottom")),
...
function EffectCreative(e) {
    ...
    effectInit({
        ...
        setTransition: (e) => {
            ...
            (s ? t.slides.find(s) : t.slides).transition(e).find(".swiper-slide-shadow").transition(e), effectVirtualTransitionEnd({ swiper: t, duration: e, transformEl: s, allSlides: !0 });
        },
...
function EffectCards(e) {
    ...
    effectInit({
        ...
        setTransition: (e) => {
            ...
            (s ? t.slides.find(s) : t.slides).transition(e).find(".swiper-slide-shadow").transition(e), effectVirtualTransitionEnd({ swiper: t, duration: e, transformEl: s });
        },
        perspective: () => !0,
        overwriteParams: () => ({ watchSlidesProgress: !0, virtualTranslate: !t.params.cssMode }),
    });
