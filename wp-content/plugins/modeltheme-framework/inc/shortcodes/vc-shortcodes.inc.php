...
-------------------------------------------------------------------*/
add_action('init','faimos_vc_shortcodes');
function faimos_vc_shortcodes(){
    ...
    if ( function_exists('vc_map') ) {
        ...
        // faimos - Testimonials Slider v2
        vc_map( 
            array(
            "name" => esc_attr__("faimos - Testimonials Slider v2", "modeltheme"),
        ...
        // faimos - Testimonials v1
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Testimonials v1", "modeltheme"),
                "base" => "testimonials",
                "category" => esc_attr__("faimos", "modeltheme"),
                "icon" => plugins_url( 'images/testimonials.svg', __FILE__ ),
                "params" => array(
        ...
        // faimos - Service icon with text
        vc_map( 
            array(
            "name" => esc_attr__("faimos - Service icon with text", "modeltheme"),
            "base" => "service",
            "category" => esc_attr__("faimos", "modeltheme"),
        ...
        vc_map( 
            array(
            "name" => esc_attr__("faimos - Shop feature", "modeltheme"),
            "base" => "shop-feature",
            "category" => esc_attr__("faimos", "modeltheme"),
        ...
        vc_map( 
            array(
            "name" => esc_attr__("faimos - Alert", "modeltheme"),
            "base" => "alert",
            "category" => esc_attr__("faimos", "modeltheme"),
        ...
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Progress bar", "modeltheme"),
                "base" => "progress_bar",
                "category" => esc_attr__("faimos", "modeltheme"),
        ...
        vc_map( 
             array(
                "name" => esc_attr__("faimos - Panel", "modeltheme"),
                "base" => "panel",
                "category" => esc_attr__("faimos", "modeltheme"),
        ...
        // faimos - Featured post
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Featured post", "modeltheme"),
                "base" => "featured_post",
                "category" => esc_attr__("faimos", "modeltheme"),
        ...
        // faimos - Service style2
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Service style2", "modeltheme"),
                "base" => "service_style2",
                "category" => esc_attr__("faimos", "modeltheme"),
                "icon" => plugins_url( 'images/service-icon-with-text.svg', __FILE__ ),
                "params" => array(
        ...
        // faimos - Skill counter
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Skill counter", 'modeltheme'),
                "base" => "mt_skill",
                "category" => esc_attr__("faimos", "modeltheme"),
        ...
        // faimos - Pricing table
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Pricing table", "modeltheme"),
                "base" => "pricing-table",
                "category" => esc_attr__("faimos", "modeltheme"),
        ...
        // faimos - Heading with Border
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Heading with Border", "modeltheme"),
                "base" => "heading-border",
                "category" => esc_attr__("faimos", "modeltheme"),
        ...
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Social icons", "modeltheme"),
                "base" => "social_icons",
                "category" => esc_attr__("faimos", "modeltheme"),
        ...
        vc_map( 
            array(
                "name" => esc_attr__("faimos - List group", "modeltheme"),
                "base" => "list_group",
                "category" => esc_attr__("faimos", "modeltheme"),
        ...
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Button", "modeltheme"),
                "base" => "faimos_btn",
                "category" => esc_attr__("faimos", "modeltheme"),
        ...
        // faimos - Thumbnails custom content
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Thumbnails custom content", "modeltheme"),
        ...
        // faimos - Heading with bottom border
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Heading with bottom border", "modeltheme"),
        ...
        // faimos - Call to Action
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Call to Action", "modeltheme"),
                "base" => "faimos-call-to-action",
                "category" => esc_attr__("faimos", "modeltheme"),
                ...
                array(
                    ...
                    "heading" => esc_attr__( "Heading", "modeltheme" ),
                    "param_name" => "heading",
                    "value" => esc_attr__( "faimos Is The Ultimate WordPress Multi-Purpose WordPress Theme!", "modeltheme" )
                ),
                array(
                    "type" => "dropdown",
                    "holder" => "div",
        ...
        // faimos - Section Title & Subtitle
        vc_map(
            array(
                "name" => __("faimos - Section Title and Subtitle", "modeltheme"),
        ...
        vc_map( 
            array(
                "name" => __("faimos - Section Title and Subtitle w/ button", "modeltheme"),
        ...
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Blog Posts", "modeltheme"),
                "base" => "faimos-blog-posts",
                "category" => esc_attr__("faimos", "modeltheme"),
         ...
         // faimos - Blog Posts v2
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Blog Posts v2", "modeltheme"),
                "base" => "faimos-blog-posts-2",
                "category" => esc_attr__("faimos", "modeltheme"),
                "icon" => plugins_url( 'images/blog.svg', __FILE__ ),
                "params" => array(
                array(
        ...
        // faimos - Masonry Banners
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Masonry Banners", "modeltheme"),
        ...
        vc_map( 
          array(
           "name" => esc_attr__("faimos - Sale Banner", "modeltheme"),
           "base" => "sale-banner",
           "category" => esc_attr__("faimos", "modeltheme"),
           "icon" => plugins_url( 'images/Thumbnail.svg', __FILE__ ),
           "params" => array(
        ...
        // faimos - Product Filters
        vc_map( 
          array(
           "name" => esc_attr__("faimos - Product Filters", 'modeltheme'),
        ...
        // faimos - Products List
        vc_map( 
          array(
           "name" => esc_attr__("faimos - Products List", "modeltheme"),
        ...
        //faimos - Products with Banners
        vc_map( 
          array(
           "name" => esc_attr__("faimos - Products w/ Banners", "modeltheme"),
        ...
        // faimos - Products Grid
        vc_map( 
          array(
            "name" => esc_attr__("faimos - Products Grid", "modeltheme"),
        ...
        // faimos - Products Styled
        vc_map(
            array(
                "name" => esc_attr__("faimos - Products Styled", 'modeltheme'),
        ...
        // faimos - Products Category Image
        vc_map( 
            array(
                "name" => esc_attr__("faimos - Products Category Image", "modeltheme"),
                "base" => "mt_faimos_category_image",
                "category" => esc_attr__("faimos", "mtlisitings"),
        ...
        // faimos - Products by Category v2
        vc_map( 
          array(
           "name" => esc_attr__("faimos - Products by Category v2", "modeltheme"),
        ...
        vc_map( array(
           "name" => __("faimos - Tabs categories"),
        ...
        // faimos - Products Slider
        
          vc_map( 
            array(
              "name" => esc_attr__("faimos - Products Slider", "modeltheme"),
        ...
        // faimos - Products Carousel
        vc_map( 
          array(
            "name" => esc_attr__("faimos - Products Carousel", "modeltheme"),
        ...
        // faimos - Members Slider
        vc_map( 
          array(
            "name" => esc_attr__("faimos - Members Slider", "modeltheme"),
   ...
   // faimos - CountDown Version 2
  vc_map( 
    array(
     "name" => esc_attr__("faimos - CountDown Version 2", 'modeltheme'),
...
// faimos - Featured Product Simple
    vc_map( 
        array(
            "name" => esc_attr__("faimos - Featured Simple Product", 'modeltheme'),
    ...
    vc_map( 
        array(
            "name" => esc_attr__("faimos - Featured Cryptocurrency", 'modeltheme'),
  ...
  vc_map( 
    array(
      "name" => esc_attr__("faimos - Typed Text", 'modeltheme'),
      "base" => "mt_typed_text",
      "category" => esc_attr__("faimos", "modeltheme"),
  ...
  vc_map( 
    array(
      "name" => esc_attr__("faimos - Video", 'modeltheme'),
  ...
  vc_map( 
    array(
     "name" => __("faimos - Products Search", 'mtlisitings'),
     "base" => "mt_ico_search",
     "category" => esc_attr__("faimos", "modeltheme"),
  ...
  vc_map( 
    array(
        "name" => esc_attr__("faimos - Map Pins", 'modeltheme'),
        "base" => "mt_map_pins",
  ...
  # Custom Images with Links
        vc_map( 
          array(
           "name" => esc_attr__("faimos - Custom Images with Links", 'modeltheme'),
