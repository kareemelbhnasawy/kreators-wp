...
* Description: ModelTheme Framework required by faimos Theme.
* Version: 1.6
* Author: ModelTheme
* Author http://modeltheme.com/
* Text Domain: modeltheme
* Last Plugin Update: 11-Jul-2023
*/
...
function faimos_RemoveDemoModeLink() { // Be sure to rename this function to something more unique
...
add_action('init', 'faimos_RemoveDemoModeLink');
