  ...
  extract( shortcode_atts( 
    ...
    <div class="mt-swipper-carusel-position" style="position:relative;">
      ...
      <div id="<?php echo esc_attr($id); ?>" 
        <?php modeltheme_addons_swiper_attributes($id, $autoplay, $delay, $items_desktop, $items_mobile, $items_tablet, $space_items, $touch_move, $effect, $grab_cursor, $infinite_loop, $centered_slides, $grid_rows); ?>
...
function mt_addons_product_category(){
  ...
  vc_map(
    array(
      "name" => esc_attr__("MT: Product Category", "modeltheme-addons-for-wpbakery"),
