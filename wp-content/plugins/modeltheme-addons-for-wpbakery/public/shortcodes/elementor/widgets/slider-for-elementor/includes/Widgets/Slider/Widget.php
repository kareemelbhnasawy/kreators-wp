 ...
 * @package AddonSlider
 */
namespace DynamicLayers\AddonSlider\Widgets\Slider;

use DynamicLayers\AddonSlider\Traits\ContentControl;
...
class Widget extends Widget_Base {
	...
	public function get_name() {
        return 'mt_addon_slider';
    }

    public function get_title() {
        return esc_html__( 'MT: Slider', 'modeltheme-addons-for-wpbakery' );
    }
    ...
    public function get_categories() {
        return ['modeltheme-addons-for-wpbakery'];
    }

    public function get_style_depends() {
        return ['splitting', 'swiper-js', 'slider-style'];
    }

    public function get_script_depends() {
        return [ 'splitting', 'slider-script' ];
    }

	public function get_keywords() {
        return [ 'slider', 'image slider', 'carousel', 'animated slider', 'Slider' ];
    }
    ...
    private function style_sub_heading() {
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Style', 'modeltheme-addons-for-wpbakery' ),
            ]
        );
        ...
        $this->add_control(
            'sh_text_stroke',
            [
                'label'        => esc_html__( 'Text Stroke', 'modeltheme-addons-for-wpbakery' ),
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__( 'Stroke Options', 'modeltheme-addons-for-wpbakery' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__( 'Stroke Width', 'modeltheme-addons-for-wpbakery' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Stroke Color', 'modeltheme-addons-for-wpbakery' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'sh_text_fill_color',
            [
                'label'     => esc_html__( 'Fill Color', 'modeltheme-addons-for-wpbakery' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab(
            'stylesh_hl_text_tab',
            [
                'label' => esc_html__( 'Mark Text', 'modeltheme-addons-for-wpbakery' ),
            ]
        );
        ...
        $this->add_control(
            'sh_hl_style',
            [
                'label'        => esc_html__( 'Custom Style', 'modeltheme-addons-for-wpbakery' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'modeltheme-addons-for-wpbakery' ),
                'label_off'    => esc_html__( 'No', 'modeltheme-addons-for-wpbakery' ),
                'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options'   => [
                    'inline-block' => [
                        'title' => esc_html__( 'Inline', 'modeltheme-addons-for-wpbakery' ),
                        'icon'  => 'eicon-ellipsis-h',
                    ],
                    'block'        => [
                        'title' => esc_html__( 'Block', 'modeltheme-addons-for-wpbakery' ),
                        'icon'  => 'eicon-menu-bar',
                    ],
                ],
    ...
    private function style_button() {
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Normal', 'modeltheme-addons-for-wpbakery' ),
            ]
        );
        ...
        $this->start_controls_tab(
            'style_btn_hover_tab',
            [
                'label' => esc_html__( 'Hover', 'modeltheme-addons-for-wpbakery' ),
            ]
        );
    ...
    private function style_play_button() {
        ...
        $this->add_responsive_control(
            'play_btn_size',
            [
                'label'      => esc_html__( 'Play Button Size', 'modeltheme-addons-for-wpbakery' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range'      => [
                    'px' => [
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Play Icon', 'modeltheme-addons-for-wpbakery' ),
            ]
        );
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Text/Label', 'modeltheme-addons-for-wpbakery' ),
            ]
        );
    ...
    protected function style_navigation() {
        ...
        $this->add_control(
            'nav_hide_mobile',
            [
                'label'        => esc_html__( 'Hide on Mobile', 'modeltheme-addons-for-wpbakery' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'yes', 'modeltheme-addons-for-wpbakery' ),
                'label_off'    => esc_html__( 'No', 'modeltheme-addons-for-wpbakery' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'nav_visibility',
            [
                'label'     => esc_html__( 'Visibility', 'modeltheme-addons-for-wpbakery' ),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'hover-on-visible',
                'options'   => [
                    'hover-on-visible' => esc_html__( 'Hover on Visible', 'modeltheme-addons-for-wpbakery' ),
                    'always-visible'   => esc_html__( 'Always Visible', 'modeltheme-addons-for-wpbakery' ),
                ],
                'condition' => [
                    'slider_nav' => 'yes',
                    'nav_layout' => '2',
        ...
        $this->add_control(
            'nav_long_arrow',
            [
                'label'        => esc_html__( 'Long Arrow', 'modeltheme-addons-for-wpbakery' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'yes', 'modeltheme-addons-for-wpbakery' ),
                'label_off'    => esc_html__( 'No', 'modeltheme-addons-for-wpbakery' ),
                'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            'nav_left_right_pos',
            [
                'label'      => esc_html__( 'Left Right Position', 'modeltheme-addons-for-wpbakery' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range'      => [
                    'px' => [
    ...
    protected function style_pagination() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '1',
                'options'   => [
                    '1' => esc_html__( 'Dots Circle', 'modeltheme-addons-for-wpbakery' ),
                    '2' => esc_html__( 'Dots', 'modeltheme-addons-for-wpbakery' ),
                    '3' => esc_html__( 'Dots Stroke', 'modeltheme-addons-for-wpbakery' ),
                    '4' => esc_html__( 'Numbers', 'modeltheme-addons-for-wpbakery' ),
                    '5' => esc_html__( 'Lines', 'modeltheme-addons-for-wpbakery' ),
                    '6' => esc_html__( 'Fraction', 'modeltheme-addons-for-wpbakery' ),
                ],
                'condition' => [
                    'slider_pagination' => 'yes',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__( 'Space Between Item', 'modeltheme-addons-for-wpbakery' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range'      => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'dots_size',
            [
                'label'      => esc_html__( 'Dots Size', 'modeltheme-addons-for-wpbakery' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range'      => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'number_line_width',
            [
                'label'      => esc_html__( 'Line Width', 'modeltheme-addons-for-wpbakery' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range'      => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'dots_active_size',
            [
                'label'      => esc_html__( 'Dot Active Size', 'modeltheme-addons-for-wpbakery' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range'      => [
                    'px' => [
        ...
        $this->add_control(
            'fraction_sep_color',
            [
                'label'     => esc_html__( 'Separator Color', 'modeltheme-addons-for-wpbakery' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab(
            ...
            [
                'label'     => esc_html__( 'Active', 'modeltheme-addons-for-wpbakery' ),
                'condition' => [
                    'slider_pagination' => 'yes',
                ],
            ]
        ...
        $this->add_responsive_control(
            'bullet_stroke_width',
            [
                'label'      => esc_html__( 'Stroke Size', 'modeltheme-addons-for-wpbakery' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range'      => [
                    'px' => [
		...
		<div <?php echo $this->get_render_attribute_string( 'slider_wrapper' ); ?>>
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide elementor-repeater-item-<?php echo esc_attr( $slide['_id'] ) ; ?>">
					<?php 
					SliderHelper::get_slider_image( $settings, $slide );
					if( 'yes' === $slide['slider_shape'] && 'angle_shape' === $slide['shape_style'] ) {
                        SliderHelper::get_slider_shapes( $slide );
                    }
					...
					<div class="slider-content-wrap text-<?php echo esc_attr($slide['content_align']); ?>">
						<div class="content-width">
							...
							<div class="slider-content">
								<?php
								SliderHelper::get_sub_heading( $slide );
								SliderHelper::get_heading( $slide );
								SliderHelper::get_description( $slide );
								$text_masking = 'yes' === $slide['text_masking'] ? ' text-masking' : '';
								?>
								<div class="mt-btn-group<?php echo esc_attr( $text_masking ); ?>">
									<?php 
									SliderHelper::get_btn( $slide );
									SliderHelper::get_secondary_btn( $slide );
									SliderHelper::get_play_btn( $slide ); 
									?>
								</div>
							</div>
						</div>
			...
			<?php
			SliderHelper::get_slider_controls( $settings['slider_nav'], $settings['slider_pagination'], $settings['nav_layout'], $settings['nav_long_arrow'], $pagiStyle, $settings['autoplay'] );
			?>
			<div class="slider-preloader"><div class="dot-flashing"></div></div>
		</div>
		<?php
		}else{
			esc_html_e( 'No slides careated. Please create the slides from the Slides section.', 'modeltheme-addons-for-wpbakery' );
		}
	}
