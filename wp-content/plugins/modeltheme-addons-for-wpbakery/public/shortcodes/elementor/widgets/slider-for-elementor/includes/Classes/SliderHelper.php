...
class SliderHelper {
    ...
    static function get_animation_effects( $exclude = [] ) {
        $effects = [
            'none'           => 'None',
            'mt-fadeIn'         => 'Fade In',
            'mt-fadeInLeft'     => 'Fade In Left',
            'mt-fadeInRight'    => 'Fade In Right',
            'mt-fadeInDown'     => 'Fade In Down',
            'mt-fadeInUp'       => 'Fade In Up',
            'clip-text'      => 'Clip Text',
            'reveal-text'    => 'Reveal Text',
            'char-top'       => 'Splitting Text Top',
            'char-right'     => 'Splitting Text Right',
            'char-bottom'    => 'Splitting Text Bottom',
            'char-expand'    => 'Splitting Text Expand',
            'mt-moveFromLeft'   => 'Move From Left',
            'mt-moveFromRight'  => 'Move From Right',
            'mt-moveFromTop'    => 'Move From Top',
            'mt-moveFromBottom' => 'Move From Bottom',
            'mt-blurIn'         => 'Blur In',
            'mt-blurInLeft'     => 'Blur In Left',
            'mt-blurInRight'    => 'Blur In Right',
            'mt-blurInTop'      => 'Blur In Top',
            'mt-blurInBottom'   => 'Blur In Bottom',
            'mt-zoomIn'         => 'Zoom In',
            'mt-zoomInLeft'     => 'Zoom In Left',
            'mt-zoomInRight'    => 'Zoom In Right',
            'mt-zoomInTop'      => 'Zoom In Top',
            'mt-zoomInBottom'   => 'Zoom In Bottom',
            'mt-flipInTop'   => 'Flip In Top',
            'mt-flipInBottom'   => 'Flip In Bottom',
            'mt-rollFromLeft'   => 'Roll From Left',
            'mt-rollFromRight'   => 'Roll From Right',
            'mt-rollFromTop'   => 'Roll From Top',
            'mt-rollFromBottom'   => 'Roll From Bottom',
            'mt-rotateSkateInRight'   => 'Rotate Skate In Right',
            'mt-rotateSkateInLeft'   => 'Rotate Skate In Left',
            'mt-rotateSkateInTop'   => 'Rotate Skate In Top',
            'mt-rotateSkateInBottom'   => 'Rotate Skate In Bottom',
            'mt-popUp'   => 'PopUp',
            'mt-popUpRight'   => 'PopUp Right',
            'mt-popUpLeft'   => 'PopUp Left',
        ];
        if( ! empty( $exclude ) ) {
