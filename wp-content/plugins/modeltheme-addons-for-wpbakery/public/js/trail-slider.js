 ...
 */
{
    class TextFX {
        constructor(el) {
            this.DOM = {el: el};
            // The texts (repeated)
            this.DOM.texts = [...this.DOM.el.querySelectorAll('.mt-addons-trail-slider-content__text')];
    ...
    class Slide {
        constructor(el) {
            this.DOM = {el: el};
            this.DOM.img = {
                wrap: this.DOM.el.querySelector('.mt-addons-trail-slider-content__img'),
                inner: this.DOM.el.querySelector('.mt-addons-trail-slider-content__img-inner')
            };
            // The text effect class.
            this.textFX = new TextFX(this.DOM.el.querySelector('.mt-addons-trail-slider-content__text-wrap'));
        }
    ...
    class Slideshow {
        constructor(el) {
            ...
            // Navigation controls
            this.DOM.nav = {
                prev: this.DOM.el.querySelector('.mt-addons-trail-slider-content__nav-button--prev'),
                next: this.DOM.el.querySelector('.mt-addons-trail-slider-content__nav-button--next')
            };
            // All slides
            this.slides = [];
            [...this.DOM.el.querySelectorAll('.mt-addons-trail-slider-content__slide')].forEach(slide => this.slides.push(new Slide(slide)));
            // Total number of slides
            this.slidesTotal = this.slides.length;
            // Current slide position
            this.current = 0;
            // Show the first one
            this.slides[this.current].DOM.el.classList.add('mt-addons-trail-slider-content__slide--current');
        ...
        navigate(dir) {
            ...
            const onCurrentHalfwayCallback = () => {
                ...
                upcomingSlide.DOM.el.classList.add('mt-addons-trail-slider-content__slide--current');
            ...
            const onCurrentEndCallback = () => {
                ...
                currentSlide.DOM.el.classList.remove('mt-addons-trail-slider-content__slide--current');
    ...
    imagesLoaded(document.querySelectorAll('.mt-addons-trail-slider-content__img-inner'), {background: true}, () => document.body.classList.remove('loading'));
}